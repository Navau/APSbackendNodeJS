...
const cargaArchivosPensionesRoute = require("./auditoria/cargaArchivosPensiones.auditoria.route");
...
function routerApi(app) {
  ...
  router.use("/CargaArchivosPensiones", cargaArchivosPensionesRoute);
  router.use(
